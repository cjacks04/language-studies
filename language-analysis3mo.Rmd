...
# import science
cos_science <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/astronomy/Agg_Weekly_cos_result_Astro.csv") 
science_theil <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/astronomy/3M_Agg_Theil_result_Astro.csv") 
science_cpd <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/astronomy/3M_Agg_CPD_result_Astro.csv") 
...
# import domain 
cos_domain <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/domain/Agg_Weekly_cos_result.csv") 
domain_theil <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/domain/3M_Agg_Theil_result.csv") 
domain_cpd <- read_csv("/Volumes/cbjackson2/language models/outputs/3 months/domain/3M_Agg_CPD_result.csv") 
...
session_builder <- session_builder[which(!is.na(session_builder$created_at)),]
...
user_info <- session_builder %>% 
   ...
   class = length(which(type=="classification")),
   comment = length(which(type=="comment")),
   join_date = as.Date(min(created_at2)),
   ...
   newcomer_end = add_with_rollback(join_date, months(3), roll_to_first = TRUE),
...
write.csv(newcomer_info,"/Volumes/cbjackson2/language models/newcomer_info.csv")
```
