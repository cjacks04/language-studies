...
#classifications <- read_csv("/Volumes/cbjackson2/Zooniverse Datasets/gravityspy/gravity-spy-classifications_72522.csv") # move to Zoonvierse Datasets folder

 comments <- read_csv("/Volumes/cbjackson2/language models/gravity-spy-comments-processed06-May-2021 11.05.csv") # move to Zoonvierse Datasets folder


```

```{r setup-classifications, include=FALSE, warning=FALSE}
session_builder1 <- data.frame(classifications$id,classifications$user_id,classifications$created_at,"classification")
