...
newcomers_week_data <- newcomers_week_data[which(newcomers_week_data$user_week<=4 & !is.na(newcomers_week_data$comment_no)),]
...
```{r}
stargazer(retentiondown.glm, retention_commentersup.glm, type = "latex")
```
